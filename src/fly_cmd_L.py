...
pub_takeoff = rospy.Publisher('/drone1/tello/takeoff', EmptyMsg, queue_size=1)
pub_land = rospy.Publisher('/drone1/tello/land', EmptyMsg, queue_size=1)
pub_vel_cmd = rospy.Publisher('/drone1/tello/cmd_vel', Twist, queue_size=1)
...
def cmd():
    global pre_time, command
    global pub_vel_cmd
    rospy.init_node('cmd_L', anonymous=True)
